...
examples: lib
	...
	$(CC) -I ./ can_interact.o examples/c/can_reader.c -lm -o examples/c/can_reader
	$(CC) -I ./ can_interact.o examples/c/can_writer.c -lm -o examples/c/can_writer
	$(CXX) -I ./ can_interact.o examples/cxx/can_reader.cc -lm -o examples/cxx/can_reader
	$(CXX) -I ./ can_interact.o examples/cxx/can_writer.cc -lm -o examples/cxx/can_writer
